...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(157904278060390818)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(157905577463390821)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(157906005788390821)
,p_name=>'Report'
,p_parent_plug_id=>wwv_flow_api.id(157905577463390821)
...
,p_query_row_template=>wwv_flow_api.id(16247602938165137949)
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_query_no_data_found=>'no data found'
,p_query_row_count_max=>500
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(157906646827390832)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(157907076431390833)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(157908835689391216)
,p_plug_name=>'Feedback'
,p_parent_plug_id=>wwv_flow_api.id(157905577463390821)
...
,p_list_id=>wwv_flow_api.id(157904925184390820)
