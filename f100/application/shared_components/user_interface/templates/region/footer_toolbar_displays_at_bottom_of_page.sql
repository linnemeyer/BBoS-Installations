...
begin
--   Manifest
--     REGION TEMPLATE: FOOTER_TOOLBAR_DISPLAYS_AT_BOTTOM_OF_PAGE
--   Manifest End
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16247803622744732261)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18332723590296121)
,p_plug_template_id=>wwv_flow_api.id(16247803622744732261)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18332846101296121)
,p_plug_template_id=>wwv_flow_api.id(16247803622744732261)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18332878894296121)
,p_plug_template_id=>wwv_flow_api.id(16247803622744732261)
,p_name=>'Change'
