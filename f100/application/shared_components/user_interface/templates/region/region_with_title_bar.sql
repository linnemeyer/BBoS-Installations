...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16247805036317732265)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18335989790296121)
,p_plug_template_id=>wwv_flow_api.id(16247805036317732265)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18336082670296121)
,p_plug_template_id=>wwv_flow_api.id(16247805036317732265)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18336205738296121)
,p_plug_template_id=>wwv_flow_api.id(16247805036317732265)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
