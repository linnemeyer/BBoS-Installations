...
begin
--   Manifest
--     REGION TEMPLATE: FOOTER_TOOLBAR_FULLSCREEN
--   Manifest End
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16247804074970732262)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18333271597296121)
,p_plug_template_id=>wwv_flow_api.id(16247804074970732262)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18333406120296121)
,p_plug_template_id=>wwv_flow_api.id(16247804074970732262)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18333458002296121)
,p_plug_template_id=>wwv_flow_api.id(16247804074970732262)
,p_name=>'Change'
