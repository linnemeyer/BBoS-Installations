...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18164306872618104)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18164809099618106)
,p_plug_template_id=>wwv_flow_api.id(18164306872618104)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18165266247618107)
,p_plug_template_id=>wwv_flow_api.id(18164306872618104)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18165816202618107)
,p_plug_template_id=>wwv_flow_api.id(18164306872618104)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18166271038618107)
,p_plug_template_id=>wwv_flow_api.id(18164306872618104)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18166823401618107)
,p_plug_template_id=>wwv_flow_api.id(18164306872618104)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18167274286618108)
,p_plug_template_id=>wwv_flow_api.id(18164306872618104)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18167814689618108)
,p_plug_template_id=>wwv_flow_api.id(18164306872618104)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18168274916618108)
,p_plug_template_id=>wwv_flow_api.id(18164306872618104)
,p_name=>'Sub Regions'
