...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16247562548318137925)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18035833619618014)
,p_plug_template_id=>wwv_flow_api.id(16247562548318137925)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18036392892618015)
,p_plug_template_id=>wwv_flow_api.id(16247562548318137925)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18036929461618015)
,p_plug_template_id=>wwv_flow_api.id(16247562548318137925)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18037423872618016)
,p_plug_template_id=>wwv_flow_api.id(16247562548318137925)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18037906401618016)
,p_plug_template_id=>wwv_flow_api.id(16247562548318137925)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18038363573618016)
,p_plug_template_id=>wwv_flow_api.id(16247562548318137925)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18038867111618016)
,p_plug_template_id=>wwv_flow_api.id(16247562548318137925)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18039400650618017)
,p_plug_template_id=>wwv_flow_api.id(16247562548318137925)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18039931203618017)
,p_plug_template_id=>wwv_flow_api.id(16247562548318137925)
,p_name=>'Sub Regions'
