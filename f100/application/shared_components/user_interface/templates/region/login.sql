...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16247573177754137931)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18108089873618065)
,p_plug_template_id=>wwv_flow_api.id(16247573177754137931)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18108577732618065)
,p_plug_template_id=>wwv_flow_api.id(16247573177754137931)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18109125715618065)
,p_plug_template_id=>wwv_flow_api.id(16247573177754137931)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18109593295618065)
,p_plug_template_id=>wwv_flow_api.id(16247573177754137931)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18110084253618066)
,p_plug_template_id=>wwv_flow_api.id(16247573177754137931)
,p_name=>'Sub Regions'
