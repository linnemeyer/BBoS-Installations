...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(155582807435345853)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18004622349617990)
,p_plug_template_id=>wwv_flow_api.id(155582807435345853)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18005077485617990)
,p_plug_template_id=>wwv_flow_api.id(155582807435345853)
,p_name=>'Sub Regions'
