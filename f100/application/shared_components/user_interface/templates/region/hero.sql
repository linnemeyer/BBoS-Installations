...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(16247568884561137929)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18069158757618038)
,p_plug_template_id=>wwv_flow_api.id(16247568884561137929)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18069634359618038)
,p_plug_template_id=>wwv_flow_api.id(16247568884561137929)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18070185590618038)
,p_plug_template_id=>wwv_flow_api.id(16247568884561137929)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18070696174618039)
,p_plug_template_id=>wwv_flow_api.id(16247568884561137929)
,p_name=>'Sub Regions'
