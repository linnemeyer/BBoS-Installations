create or replace function bb_grouped_install_notes (p_order_id number, p_install_part_id number, p_grouping varchar2) return varchar is
   cursor data_cur is 
